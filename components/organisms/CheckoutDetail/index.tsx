    ...
    return (
        <>
            <div className="purchase pt-md-50 pt-30">
                ...
                <p className="text-lg color-palette-1 mb-20">Item <span className="purchase-details">{dataTopUp.nominalItem.conQuantity} {dataTopUp.nominalItem.coinName}</span></p>
